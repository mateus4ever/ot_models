...
# Load data (replace with your target stock file, e.g., UPRO or SPXU)
df = pd.read_csv("upro_eod.csv", parse_dates=["Datetime"])  # or "spxu_data.csv"
...
# Benchmark comparison (Buy & Hold for leveraged ETF)
...
plt.title("EMA Crossover Strategy vs Buy & Hold (Leveraged ETF)")
plt.xlabel("Date")
